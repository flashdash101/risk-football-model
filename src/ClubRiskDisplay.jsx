...
const fetchClubs = async () => {
  const response = await axios.get('https://football-risk-assessment4-mkj3ly2lna-uc.a.run.app/api/clubs');
...
const fetchRiskData = async (clubNames) => {
  const response = await axios.post('https://football-risk-assessment4-mkj3ly2lna-uc.a.run.app/api/risk', { club_names: clubNames });
